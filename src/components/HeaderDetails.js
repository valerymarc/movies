...
import { calculTime, convertMoney } from '../utils/helper';
import { faMoneyCheckAlt, faClock } from '@fortawesome/fontawesome-free-solid';
    ...
    render() {
        ...
        return (<div className="headerDetails">
            ...
            <div className="headerDetails--poster">
                <img className="headerDetails--poster__img" alt="detailsImg" src={imgSrc} />
            </div>
            <div className="headerDetails--container">
                ...
                <div className="headerDetails--info">
                   <Container iconName="clock" content={calculTime(this.props.runtime)} icon={faClock}/>
                   <Stars fakeArray1={this.fakeArray1} fakeArray2={this.fakeArray2} />
                   <Container iconName="money" content={convertMoney(this.props.revenue)} icon={faMoneyCheckAlt} />
                </div>
            </div>
        </div>)
    }
